...
const MapSearch = () => {
      ...
      geocoder.geocode({ address: searchQuery }, (geocodeResults, geocodeStatus) => {
        ...
        service.nearbySearch(request, (results, status) => {
          ...
          if (status === 'OK' && results && results.length > 0) {
            ...
            // Adjust zoom if it's too close or too far
            setTimeout(() => {
  ...
  const calculateRoute = async () => {
    ...
    // Route feature disabled for now
    alert('Route feature will be implemented later');
  };
  ...
  const optimizeRoute = async () => {
    ...
    // Route optimization feature disabled for now
    alert('Route optimization will be implemented later');
  };
    ...
    <div className="map-search-container">
      ...
      <div className="map-wrapper">
        ...
        >
          ...
          {/* Directions Renderer - Removed for now */}
        </GoogleMap>
      </div>
    </div>
  );
